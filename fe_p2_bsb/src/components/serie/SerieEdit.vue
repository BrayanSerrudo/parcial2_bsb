...
async function getSerie() {
  await http.get(`${ENDPOINT}/${id}`).then((response) => {
    ; (titulo.value = response.data.titulo), (sinopsis.value = response.data.sinopsis), (director.value = response.data.director), (temporadas.value = response.data.temporadas), (fechaEstreno.value = response.data.fechaEstreno), (categoria.value = response.data.categoria)
  })
}
  ...
  <div class="container">
    ...
    <div class="row">
      <form @submit.prevent="editarSerie">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" v-model="temporadas" placeholder="Temporada" required />
